...
function render() {
  ...
  // End frame tracking
  simplePerformanceTracker.endFrame()
...
// REMOVED: Complex performance benchmark system
// Simple debug-only performance tracking now handled by simplePerformanceTracker
