// vRacer Racing Line Editor - Track Renderer Module (Fixed)
...
class TrackRenderer {
    ...
    // Main render method
    render() {
        const CanvasUtils = window.EditorUtils.CanvasUtils;
    ...
    renderRacingLine() {
        const CanvasUtils = window.EditorUtils.CanvasUtils;
        const ColorUtils = window.EditorUtils.ColorUtils;
    ...
    setScale(scale) {
        const MathUtils = window.EditorUtils.MathUtils;
